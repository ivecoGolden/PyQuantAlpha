...
| 任务 | 状态 | 说明 |
|------|------|------|
| T10: 标准化分析器集 | 📋 | Sharpe, Max DD, Profit Factor |
| T11: 基准对比 | 📋 | BTC Benchmark 对标 |

### 2.5 [P2] 用户配置增强 📋 规划中

| 任务 | 状态 | 说明 |
|------|------|------|
| T12: 策略内资金配置 | 📋 | 策略 `init()` 中调用 `self.set_capital()` |
| T13: 日志系统增强 | 📋 | 支持 Bracket/OCO/Trail 订单详细日志 |
...
| 3.4 | 业绩评价系统 | 📋 规划中 | - |
| 3.5 | 用户配置增强 | 📋 规划中 | T12-T13 |
| 3.6 | 可视化增强 | 📋 规划中 | T14-T15 |

**当前测试统计**: 438 tests passed
